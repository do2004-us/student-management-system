...
$assignments = $database
    ->query('SELECT class_subjects.id, classes.class_name, subjects.subject_name, subjects.subject_code
             FROM class_subjects
             INNER JOIN classes ON classes.id = class_subjects.class_id
...
<head>
    ...
    <title>Assign Subjects - <?= e(app_config('app_name')); ?></title>
    ...
    <main class="app-layout">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="class-subjects.php" class="active">Class Subjects</a>
                <a href="#">Attendance</a>
                <a href="#">Results</a>
                <a href="#">Fees</a>
                <a href="#">Reports</a>
        ...
        <section class="main-area">
            ...
            <section class="management-grid">
                <article class="content-panel">
                    ...
                    <form action="save-class-subject.php" method="POST" class="stack-form">
                    ...
                    <div class="table-wrap">
                        <table>
                            ...
                            <tbody>
                                <?php if (!$assignments): ?>
                                    <tr>
                                        <td colspan="5">No class subject assignments found.</td>
                                    </tr>
                                <?php endif; ?>
                                ...
                                <?php foreach ($assignments as $index => $assignment): ?>
                                    <tr>
                                        ...
                                        <td><?= e($assignment['subject_code']); ?></td>
                                        <td class="table-actions">
                                            <form action="delete-class-subject.php" method="POST">
